...
begin
  ...
  begin
    ...
    begin
      ...
      Ch_CL11.LeftAxis.Title.Caption:='Частота, Гц';
      Ch_CL21.LeftAxis.Title.Caption:='Частота, Гц';
      Ch_CL31.LeftAxis.Title.Caption:='Частота, Гц';
      Ch_CL12.LeftAxis.Title.Caption:='Частота, Гц';
      Ch_CL22.LeftAxis.Title.Caption:='Частота, Гц';
      Ch_CL32.LeftAxis.Title.Caption:='Частота, Гц';
    end;
    ...
    begin
      ...
      begin
        ...
        Ch_CL12.LeftAxis.Title.Caption:='Уровень';
        Ss_CL22.Clear; Ss_CL22.AddXY(P1,Lev1); Ss_CL22.AddXY(P2,Lev2+1);
        Ch_CL22.LeftAxis.Title.Caption:='Уровень';
        Ss_CL32.Clear; Ss_CL32.AddXY(P1,Lev1); Ss_CL32.AddXY(P2,Lev2+1);
        Ch_CL32.LeftAxis.Title.Caption:='Уровень';
      end;
    end;

    if bWLAxisXT then BTitle:='Время, сек';
    if bWLAxisXN then BTitle:='Осчеты';
    ...
    TTitle:=FloatToStrF(Freq[Lev],ffFixed,4,4)+' - '+
     FloatToStrF(Freq[Lev+1],ffFixed,4,4)+' Гц';
...
begin
  ...
  begin
    ...
    begin
      ...
      for Ax:=1 to nAxis[1] do
      begin
        Form1.Ed_Status.Text:=' Проба 1, Ось '+IntToStr(Ax)+': Вейвлет-анализ';
  ...
  begin
    Form1.Ed_Status.Text:=' Проба №2: Вейвлет-анализ';
    Form1.Ed_Status.Update;
    P2:=Power2(Lev0);
    ...
    begin
      ...
      for Ax:=1 to nAxis[2] do
      begin
        Form1.Ed_Status.Text:=' Проба 2, Ось '+IntToStr(Ax)+': Вейвлет-анализ';
        Form1.Ed_Status.Update;
        for i:=0 to P22-1 do
...
begin
  ...
  begin
    ...
    begin
      ...
      IntToStr(NCY1[Pr]+dXN*(Smpl+1)-1)+'       Отсчет';
    end;
    if bWLAxisXT then
    begin
      dXT:=Power2(Lev0)*dT/P2;
      pCh[Ax,Pr].BottomAxis.Title.Caption:=FloatToStr(TC1[Pr]+dXT*Smpl-1)+' - '+
       FloatToStr(TC1[Pr]+dXT*(Smpl+1)-1)+'      Время, сек';
    end;
    pCh[Ax,Pr].LeftAxis.Title.Caption:='Уровень    '+IntToStr(Lev);
